...
app.post('/process_cart', function(req, res) {
    ...
    if (item.quantity1 != 0) {
        ...
        order_desc.push(item.size1 + ', ' + item.color1);
        if ((item.size1 == 'Youth Small') || (item.size1 == 'Youth Medium') || (item.size1 == 'Youth Large')){
            order_desc.push(4000);
        } else {
            order_desc.push(5500);
        }
    }
    if (item.quantity2 != 0) {
        order_size++;
        order_desc.push(item.quantity2);
        order_desc.push(item.size2 + ', ' + item.color2);
    ...
    if (item.quantity3 != 0) {
        ...
        order_desc.push(item.size3 + ', ' + item.color3);
    ...
    if (item.quantity4 != 0) {
        ...
        order_desc.push(item.size4 + ', ' + item.color4);
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: [
                ...
                price_data: {
                    ...
                    unit_amount: local_desc[2],
                },
                quantity: local_desc[0],
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: [
                ...
                price_data: {
                    ...
                    unit_amount: local_desc[5],
                },
                quantity: local_desc[3],
                description: 'EMA Online Store',
                },
            ],
            mode: 'payment',
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: [
                ...
                price_data: {
                    ...
                    unit_amount: local_desc[8],
                },
                quantity: local_desc[6],
                description: 'EMA Online Store',
                },
            ],
            mode: 'payment',
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            line_items: [
                ...
                price_data: {
                    ...
                    unit_amount: local_desc[11],
                },
                quantity: local_desc[9],
                description: 'EMA Online Store',
                },
            ],
            mode: 'payment',
